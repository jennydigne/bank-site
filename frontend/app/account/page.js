...
export default function Account() {
    ...
    useEffect(() => {
        ...
        const fetchBalance = async () => {
            try {
                const response = await fetch("http://ec2-51-20-3-152.eu-north-1.compute.amazonaws.com:3002/me/accounts", {
                    method: "POST",
    ...
    const depositMoney = async () => {
        ...
        try {
            const token = localStorage.getItem("bankToken");
            const response = await fetch("http://ec2-51-20-3-152.eu-north-1.compute.amazonaws.com:3002/me/accounts/transactions", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    const logout = async () => {
        ...
        try {
            const response = await fetch("http://ec2-51-20-3-152.eu-north-1.compute.amazonaws.com:3002/logout", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ token }),
            });
